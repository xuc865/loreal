...
# Which class split to use for base-to-new experiments: all, base or new
...
_C.TRAINER = CN()
_C.TRAINER.NAME = ""
_C.TRAINER.MODAL = "base2novel"
_C.TRAINER.LEVEL = 0

# CoOp
_C.TRAINER.COOP = CN()
_C.TRAINER.COOP.N_CTX = 16
_C.TRAINER.COOP.CTX_INIT = ""
_C.TRAINER.COOP.CSC = False
_C.TRAINER.COOP.CLASS_TOKEN_POSITION = "end"
_C.TRAINER.COOP.PREC = "fp16"

# Attribute-driven prompts for LOREAL
_C.TRAINER.ATPROMPT = CN()
_C.TRAINER.ATPROMPT.USE_ATPROMPT = True
_C.TRAINER.ATPROMPT.ATT_NUM = 5
_C.TRAINER.ATPROMPT.N_ATT1 = 2
_C.TRAINER.ATPROMPT.N_ATT2 = 2
_C.TRAINER.ATPROMPT.N_ATT3 = 2
_C.TRAINER.ATPROMPT.N_ATT4 = 2
_C.TRAINER.ATPROMPT.N_ATT5 = 2
_C.TRAINER.ATPROMPT.ATT1_TEXT = "color"
_C.TRAINER.ATPROMPT.ATT2_TEXT = "shape"
_C.TRAINER.ATPROMPT.ATT3_TEXT = "size"
_C.TRAINER.ATPROMPT.ATT4_TEXT = "structure"
_C.TRAINER.ATPROMPT.ATT5_TEXT = "outline"

# PromptKD-style temperature/weight reused by LOREAL's HLD term
_C.TRAINER.PROMPTKD = CN()
_C.TRAINER.PROMPTKD.TEMPERATURE = 1.0
_C.TRAINER.PROMPTKD.KD_WEIGHT = 1.0

# LOREAL low-resolution/self-distillation options
_C.LOREAL = CN()
_C.LOREAL.OSIZE = 224
_C.LOREAL.TOSIZE = 224
_C.LOREAL.SEVERITY = 0
_C.LOREAL.FORCE = False
_C.LOREAL.STAGE = 0
_C.LOREAL.DIM = 32
_C.LOREAL.TEMP = 1.0
_C.LOREAL.COEF1 = 1.0
_C.LOREAL.COEF2 = 2.0
_C.LOREAL.ALIGN_MIX_MAX = 0.7
_C.LOREAL.ALIGN_MIX_START = 0.01
_C.LOREAL.COEF_TCE = 0.0
_C.LOREAL.COEF_BPD = 0.0
_C.LOREAL.GATE_INIT = 0.0
_C.LOREAL.LOGIT_BLEND = 1.0
_C.LOREAL.BLEND_TRAIN = False
_C.LOREAL.ADAPTIVE_BLEND = False
_C.LOREAL.ADAPTIVE_MAX_BASE = 0.5
_C.LOREAL.ADAPTIVE_POWER = 2.0
_C.LOREAL.PROMPT_ORDER = "attr_ctx_cls"
_C.LOREAL.SYUME = ""
_C.LOREAL.SAVE = "result_AAA.txt"
_C.LOREAL.MYTH = 0
_C.LOREAL.STAGE1_DIR = ""
_C.LOREAL.STAGE2_DIR = ""

# Some dataset wrappers still check this legacy switch.
_C.SPLE = CN()
_C.SPLE.KD_INFER = ""
