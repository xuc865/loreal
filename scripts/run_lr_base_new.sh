...
LOREAL_ALIGN_MIX_MAX="${LOREAL_ALIGN_MIX_MAX:-1.0}"
LOREAL_ALIGN_MIX_START="${LOREAL_ALIGN_MIX_START:-0.0}"
LOREAL_COEF_BPD="${LOREAL_COEF_BPD:-0.1}"
...
LOREAL_OPTS=(
  ...
  LOREAL.ALIGN_MIX_MAX "${LOREAL_ALIGN_MIX_MAX}"
  LOREAL.ALIGN_MIX_START "${LOREAL_ALIGN_MIX_START}"
  LOREAL.COEF_BPD "${LOREAL_COEF_BPD}"
...

{
  ...
  echo "loreal_align_mix_max=${LOREAL_ALIGN_MIX_MAX}"
  echo "loreal_align_mix_start=${LOREAL_ALIGN_MIX_START}"
  echo "loreal_coef_bpd=${LOREAL_COEF_BPD}"
