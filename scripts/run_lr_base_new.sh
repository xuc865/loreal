...
LOREAL_ALIGN_CE_MAX="${LOREAL_ALIGN_CE_MAX:-0.5}"
LOREAL_ALIGN_CE_START="${LOREAL_ALIGN_CE_START:-0.3}"
...
LOREAL_OPTS=(
  ...
  LOREAL.ALIGN_CE_MAX "${LOREAL_ALIGN_CE_MAX}"
  LOREAL.ALIGN_CE_START "${LOREAL_ALIGN_CE_START}"
...

{
  ...
  echo "loreal_align_ce_max=${LOREAL_ALIGN_CE_MAX}"
  echo "loreal_align_ce_start=${LOREAL_ALIGN_CE_START}"
