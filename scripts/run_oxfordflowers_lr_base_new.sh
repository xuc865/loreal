...
LOREAL_BPD="${LOREAL_BPD:-0.5}"
LOREAL_COEF1="${LOREAL_COEF1:-0.5}"
LOREAL_COEF2="${LOREAL_COEF2:-1.0}"
LOREAL_GATE_INIT="${LOREAL_GATE_INIT:-0.01}"
LOREAL_LOGIT_BLEND="${LOREAL_LOGIT_BLEND:-1.0}"
LOREAL_BLEND_TRAIN="${LOREAL_BLEND_TRAIN:-False}"
LOREAL_ADAPTIVE_BLEND="${LOREAL_ADAPTIVE_BLEND:-True}"
